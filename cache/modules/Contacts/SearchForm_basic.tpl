...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='first_name_basic'> {sugar_translate label='LBL_FIRST_NAME' module='Contacts'}
		</td>
...
<input type='text' name='{$fields.first_name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='last_name_basic'> {sugar_translate label='LBL_LAST_NAME' module='Contacts'}
		</td>
